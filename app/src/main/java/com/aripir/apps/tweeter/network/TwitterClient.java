package com.aripir.apps.tweeter.network;
...
public class TwitterClient extends OAuthBaseClient {
	...
	public void composeTweet(String tweetText, AsyncHttpResponseHandler handler){
	...
	public void sendReply(String status, String inReplyStatusId, AsyncHttpResponseHandler handler){
		String apiUrl = getApiUrl("/statuses/update.json");
		RequestParams params = new RequestParams();
